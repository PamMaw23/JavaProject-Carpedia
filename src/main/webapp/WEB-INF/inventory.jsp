...
<body>
	<div class="frame7">
						...
						<div class="container-fluid">
							<div class="navbar-brand d-flex" style="color: gray;">
								...
								<div class="collapse navbar-collapse d-flex" id="navbarNavDropdown">
									...
									<a href="/dashboard"><button class="button" type="submit" style="margin-left:620px; width:77px;" class="btn btn-primary">Back</button></a>
		...
		<div style="margin-left:100px;"><h1 style="color:white; font-family: ravensara;">Available Vehicles</h1></div>
